...
const static bool sold_mask_check[7] = { ITEMGETINF_SOLD_KEATON_MASK, ITEMGETINF_SOLD_SKULL_MASK, ITEMGETINF_SOLD_SPOOKY_MASK, ITEMGETINF_OTHER_MASKS_AVAILABLE, ITEMGETINF_OTHER_MASKS_AVAILABLE, ITEMGETINF_OTHER_MASKS_AVAILABLE, ITEMGETINF_MASK_OF_TRUTH_LOANED };
