...
static progression_t progressions[] = {
    { "Talked Malon Castle",     EVENT,       EVENTCHKINF_TALKED_TO_MALON_FIRST_TIME, 0                          },
    { "Got Weird Egg",           EVENT,       EVENTCHKINF_RECEIVED_WEIRD_EGG,         0                          },
    { "Woken Talon Castle",      EVENT,       EVENTCHKINF_TALON_WOKEN_IN_CASTLE,      0                          },
    { "Zelda Visited",           EVENT,       EVENTCHKINF_VISITED_ZELDA,              0                          },
    { "Zelda Fleed",             EVENT,       EVENTCHKINF_ZELDA_FLEED_FROM_CASTLE,    0                          },
    { "Gave Zelda's Letter",     INFTABLE,    INFTABLE_GIVEN_ZELDAS_LETTER,           0                          },
    { "Gave Letter King Zora",   EVENT,       EVENTCHKINF_GAVE_LETTER_TO_KING_ZORA,   0                          },
    ...
    { "Deku Tree Died",          EVENT,       EVENTCHKINF_DEKU_TREE_DIED,             0                          },
    { "Got Kokiri's Emerald",    EVENT,       EVENTCHKINF_GOT_KOKIRIS_EMERALD,        0                          },
    { "Got Goron's Ruby",        EVENT,       EVENTCHKINF_GOT_GORONS_RUBY,            0                          },
    { "Got Zora's Sapphire",     EVENT,       EVENTCHKINF_GOT_ZORAS_SAPPHIRE,         0                          },
    { "Cleansed Kokiri Forest",  EVENT,       EVENTCHKINF_CLEANSED_KOKIRI_FOREST,     0                          },
    { "Cleansed Death Mountain", EVENT,       EVENTCHKINF_CLEANSED_DEATH_MOUNTAIN,    0                          },
    { "Cleansed Lake Hylia",     EVENT,       EVENTCHKINF_CLEANSED_LAKE_HYLIA,        0                          },
    { "Drained Well",            EVENT,       EVENTCHKINF_DRAINED_WELL,               0                          },
    { "Sheik Reveal",            EVENT,       EVENTCHKINF_SHEIK_REVEAL_CS,            0                          },
    { "Rainbow Bridge",          EVENT,       EVENTCHKINF_CREATED_RAINBOW_BRIDGE,     0                          },
    { "Killed Gohma",            SCENE_CLEAR, 1,                                      SCENE_DEKU_TREE_BOSS       },
    { "Killed King Dodongo",     SCENE_CLEAR, 1,                                      SCENE_DODONGOS_CAVERN_BOSS },
    { "Killed Barinade",         SCENE_CLEAR, 1,                                      SCENE_JABU_JABU_BOSS       },
    { "Killed Phantom Ganon",    SCENE_CLEAR, 1,                                      SCENE_FOREST_TEMPLE_BOSS   },
    { "Killed Volvagia",         SCENE_CLEAR, 1,                                      SCENE_FIRE_TEMPLE_BOSS     },
    { "Killed Morhhpa",          SCENE_CLEAR, 1,                                      SCENE_WATER_TEMPLE_BOSS    },
                ...
                if (pad_pressed.a) {
                    switch (progression.type) {
                        ...
                        case INFTABLE:
                            ...
                            break;
                        case SCENE_CLEAR:
                            z64_file.scene_flags[progression.scene_id].clear ^= (1 << progression.flag);
                            break;
                        case CARPENTERS:
            ...
            case PROGRESSIONS:
                ...
                switch (progressions[curr].type) {
                    ...
                    case INFTABLE:
                        ...
                        break;
                    case SCENE_CLEAR:
                        save = z64_file.scene_flags[progressions[curr].scene_id].clear & (1 << progressions[curr].flag) ? 1 : 0;
                        break;
                    case CARPENTERS:
